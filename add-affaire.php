                             ...
                             <form id="add-affaire-form" action="controller/AffaireActionController.php" method="POST" class="horizontal-form" enctype="multipart/form-data">
                                ...
                                <div class="row-fluid">
                                    <div class="span6">
                                        <div class="control-group">
                                            <div class="controls">
                                                <input required="required" type="text" id="numero" name="numero" class="m-wrap span12" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="span1">
                                        ...
                                        <div class="control-group">
                                            <div class="controls">
                                                <select name="status" class="m-wrap span12">
                                                    <option checked="checked" value="Terminee">Terminee</option>
                                ...
                                <div class="row-fluid">
                                    <div class="span3 ">
                                        <div class="control-group autocomplet_container">
                                            ...
                                            <div class="controls">
                                                <input required="required" type="text" id="nomClient" name="nomClient" class="m-wrap span12" onkeyup="autocomplet()" />
                                    ...
                                    <div class="span3">
                                       <div class="control-group">
                                           ...
                                           <div class="controls">
                                               <input type="text" id="telephoneClient" name="telephoneClient" class="m-wrap span12" />
                                           </div>
                                       </div>
                                   	</div>
                                   	<div class="span3">
                                ...
                                <div class="row-fluid">
                                      ...
                                      <div class="control-group autocomplet_container">
                                         ...
                                         <div class="controls">
                                            <input type="text" id="nomSource" name="nomSource" class="m-wrap span12" onkeyup="autocomplet_source()" />
                                   ...
                                   <div class="span4">
                                      <div class="control-group">
                                         ...
                                         <div class="controls">
                                            <input type="text" id="telephoneSource" name="telephoneSource" class="m-wrap span12" />
                                         </div>
                                      </div>
                                   </div>
                                   <div class="span4">
                                ...
                                <div class="row-fluid">
                                    ...
                                    <div class="span3 hiddenInput">
                                        <div class="control-group autocomplet_container">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="nomTopographe" name="nomTopographe" class="m-wrap span12" onkeyup="autocomplet_topographe()" />
                                    ...
                                    <div class="span3 hiddenInput">
                                        <div class="control-group autocomplet_container">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="nomService" name="nomService" class="m-wrap span12" onkeyup="autocomplet_service()" />
